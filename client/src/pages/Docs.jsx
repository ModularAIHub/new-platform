...
const DocsPage = () => (
  <>
    <Helmet>
      ...
      <meta name="description" content="Learn how to set up SuiteGenie, connect Twitter and LinkedIn, add your OpenAI API key (BYOK), and start generating and scheduling social content in minutes." />
      <link rel="canonical" href="https://suitegenie.in/docs" />
      <meta property="og:title" content="Help & Documentation – SuiteGenie" />
      <meta property="og:description" content="Learn how to set up SuiteGenie, connect Twitter and LinkedIn, add your OpenAI API key (BYOK), and start generating and scheduling social content in minutes." />
      ...
      <meta name="twitter:description" content="Learn how to set up SuiteGenie, connect Twitter and LinkedIn, add your OpenAI API key (BYOK), and start generating and scheduling social content in minutes." />
          ...
          "mainEntity": [
            {
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Sign up, connect your socials, and add your OpenAI API key (BYOK) in Settings."
              }
            },
            {
              "@type": "Question",
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Yes, SuiteGenie is free to use with your own OpenAI API key."
              }
            }
          ]
        }
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-8 py-10 text-base text-gray-800" role="main">
      ...
      <p className="mb-8 text-lg text-gray-700 leading-relaxed">This guide walks you through setting up SuiteGenie, connecting Twitter and LinkedIn, adding your OpenAI API key (BYOK), and creating your first scheduled posts.</p>
      ...
      <h3 id="1-2-get-your-openai-api-key-byok" className="text-lg font-semibold mb-2 scroll-mt-24 text-primary-600">1.2 Get Your OpenAI API Key (BYOK)</h3>
      <ol className="list-decimal pl-6 mb-4">
        <li>Visit <strong>platform.openai.com</strong> and log in.</li>
        <li>Go to <strong>API keys</strong> in the sidebar.</li>
        <li>Click <strong>Create new secret key</strong>.</li>
        <li>Copy the key (starts with <code>sk-…</code>) and store it somewhere safe – OpenAI only shows it once.</li>
        <li>Optionally set a <strong>monthly usage limit</strong> in OpenAI Billing so you never overspend.</li>
      </ol>
      ...
      <p className="mb-6">If validation fails, double‑check that there are no extra spaces and that the key is still active in your OpenAI dashboard.</p>
      ...
      <div className="mt-16 mb-10 p-6 bg-gradient-to-br from-primary-50 to-purple-50 border border-primary-100 rounded-xl shadow-sm">
        ...
        <ol className="list-decimal pl-6 mb-4">
          ...
          <li>Type what you want the post to be about (story, lesson, case study, announcement).</li>
          <li>Pick a format like “Story + Lesson”, “How‑to”, or “List post”.</li>
          <li>Generate, then tweak the copy so it sounds like you.</li>
      ...
      <div className="mt-16 mb-10 p-6 bg-gradient-to-br from-primary-50 to-purple-50 border border-primary-100 rounded-xl shadow-sm">
        ...
        <ol className="list-decimal pl-6 mb-4">
          ...
          <li>Confirm and you’ll see it appear on your calendar.</li>
        </ol>
        ...
        <ol className="list-decimal pl-6 mb-4">
          ...
          <li>Review the calendar preview and confirm.</li>
        </ol>
      ...
      <div className="mt-16 mb-10 p-6 bg-white border border-gray-100 rounded-xl shadow-sm">
        ...
        <h3 className="text-lg font-semibold mb-4 text-primary-600">6.1 OpenAI Key Errors</h3>
        <ul className="list-disc pl-6 mb-2">
          <li>Key pasted with extra spaces.</li>
          <li>Key revoked or expired in OpenAI.</li>
          <li>No billing method or quota exhausted in OpenAI.</li>
        </ul>
        <p className="mb-2"><strong>Fix:</strong></p>
        <ul className="list-disc pl-6 mb-4">
          <li>Copy the key again carefully.</li>
          <li>Check OpenAI <strong>Billing → Usage</strong> and <strong>Limits</strong>.</li>
      ...
      <div className="mt-16 mb-10 p-6 bg-gradient-to-br from-primary-50 to-purple-50 border border-primary-100 rounded-xl shadow-sm">
        ...
        <ul className="list-disc pl-6 mb-4">
          <li>Deeper LinkedIn features and more templates.</li>
          <li>WordPress / blog automation.</li>
          <li>Team workspaces and Pro plan for agencies.</li>
        </ul>
      ...
      <div className="mt-16 mb-10 p-6 bg-white border border-gray-100 rounded-xl shadow-sm">
        ...
        <ul className="list-disc pl-6 mb-2">
          ...
          <li>Or DM us on Twitter <strong>@Suitegenie1</strong></li>
        </ul>
