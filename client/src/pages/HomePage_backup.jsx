  ...
  return (
    ...
    <section className="min-h-[80vh] flex flex-col items-center justify-center px-4 text-center bg-gradient-to-br from-blue-50 via-purple-50 to-green-50">
      ...
      >
        ...
        <FadeInSection>
          <section className="w-full px-4 py-12 bg-gradient-to-br from-blue-50 via-purple-50 to-green-50">
            <h2 className="text-4xl font-bold text-gray-800 text-center mb-12 tracking-tight">Why Creators Love Our Platform</h2>
            <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 bg-white/80 backdrop-blur-md rounded-3xl p-10 border border-blue-200/40 shadow-2xl">
              <div className="flex flex-col items-start p-8 rounded-2xl bg-white/80 backdrop-blur-lg border border-blue-100/40 shadow-lg min-h-[220px] animate-fadein-up delay-100">
                <h3 className="text-2xl font-bold text-gray-800 mb-3 tracking-tight">One Dashboard, Every Channel</h3>
                <p className="text-gray-600 text-base leading-relaxed">
                  Access a growing library of purpose-built modules for your favorite social media platforms, blogs, and content channels. <span className="font-semibold text-blue-600">Replace at least 4 separate tool subscriptions</span> and consolidate your entire workflow.
                </p>
              </div>
              <div className="flex flex-col items-start p-8 rounded-2xl bg-white/80 backdrop-blur-lg border border-blue-100/40 shadow-lg min-h-[220px] animate-fadein-up delay-200">
                <h3 className="text-2xl font-bold text-gray-800 mb-3 tracking-tight">Always On, Never Offline</h3>
                <p className="text-gray-600 text-base leading-relaxed">
                  Our intelligent multi-AI fallback engine automatically routes your request to the fastest, most reliable model—ensuring <span className="font-semibold text-blue-600">99.9% uptime</span> for your content generation so you never hit a dead end.
                </p>
              </div>
              <div className="flex flex-col items-start p-8 rounded-2xl bg-white/80 backdrop-blur-lg border border-blue-100/40 shadow-lg min-h-[220px] animate-fadein-up delay-300">
                <h3 className="text-2xl font-bold text-gray-800 mb-3 tracking-tight">Your Voice, Amplified</h3>
                <p className="text-gray-600 text-base leading-relaxed">
                  Launch the right module for the job. We understand the unique nuances of every content format, from snappy social updates to in-depth, SEO-optimized articles. <span className="font-semibold text-blue-600">Your unique brand will always shine through.</span>
                </p>
              </div>
              <div className="flex flex-col items-start p-8 rounded-2xl bg-white/80 backdrop-blur-lg border border-blue-100/40 shadow-lg min-h-[220px] animate-fadein-up delay-400">
                <h3 className="text-2xl font-bold text-gray-800 mb-3 tracking-tight">Built for Growth</h3>
                <p className="text-gray-600 text-base leading-relaxed">
                  Each module is designed to streamline your workflow, from bulk scheduling and analytics to encrypted API-key management. <span className="font-semibold text-blue-600">Scale from solo creator to full agency</span> with tools built for efficiency.
                </p>
              </div>
            </div>
          </section>
        ...
        {/* Section Divider */}
        <div className="w-full flex justify-center my-16 bg-gradient-to-br from-blue-50 via-purple-50 to-green-50">
          <div className="w-24 h-1 rounded-full bg-gradient-to-r from-blue-400 via-purple-400 to-green-400 opacity-60"></div>
        </div>

        {/* Deep Dive Section: Problem, Solution, Comparison, Features */}
        <FadeInSection>
          <section className="w-full max-w-5xl mx-auto mb-16 p-12 bg-white/80 backdrop-blur-xl rounded-3xl border border-blue-200/40 shadow-2xl text-gray-800 bg-gradient-to-br from-blue-50 via-purple-50 to-green-50">
            ...
            <p className="text-xl mb-8 text-center leading-relaxed">
              We get it. The <span className="font-semibold text-blue-600">average creator spends over 10 hours a week just managing the logistics of content</span>. Today's tools promise to help, but they often create more work by forcing you into a fragmented and inefficient workflow.
            </p>
            <p className="text-xl mb-12 text-center font-bold text-blue-700">
              We built this platform to fix that.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-14">
              <div className="bg-white/80 rounded-2xl p-8 flex flex-col items-center min-h-[200px] shadow-lg border border-blue-100/40">
                <span className="text-4xl mb-3">😩</span>
                <h3 className="font-bold mb-3 text-2xl text-blue-600 tracking-tight">The Old Way</h3>
              ...
              <div className="bg-white/80 rounded-2xl p-8 flex flex-col items-center min-h-[200px] shadow-lg border border-blue-100/40">
                <span className="text-4xl mb-3">✅</span>
                <h3 className="font-bold mb-3 text-2xl text-blue-600 tracking-tight">The New Way</h3>
                <p className="text-gray-600 text-base text-center leading-relaxed">
                  One platform, powerful modules. Choose your channel, generate optimized content, and schedule your posts, saving <span className="font-semibold text-blue-600">₹8,000–₹25,000/month</span> on tool subscriptions.
                </p>
              </div>
              <div className="bg-white/80 rounded-2xl p-8 flex flex-col items-center min-h-[200px] shadow-lg border border-blue-100/40">
                <span className="text-4xl mb-3">✨</span>
                <h3 className="font-bold mb-3 text-2xl text-blue-600 tracking-tight">The Result</h3>
                <p className="text-gray-600 text-base text-center leading-relaxed">
            ...
            <h3 className="text-3xl font-extrabold mb-6 mt-14 text-center tracking-tight text-gray-800">
              The Core Problem: A Workflow Stuck in the Past
            </h3>
            <ul className="list-disc pl-8 text-gray-600 mb-12 space-y-3 text-lg">
              <li>
              ...
              return (
                <section className="flex flex-col md:flex-row gap-8 items-start justify-center w-full max-w-6xl mx-auto py-12">
                  ...
                  <div className="flex-1 min-w-[300px]">
                    <h3 className="text-2xl font-bold mb-6 text-gray-800">The Features You've Been Missing</h3>
                    <FeatureAccordion
                      features={features}
                      openIndex={openIndex}
                  ...
                  <div className="flex-1 flex items-center justify-center min-w-[300px]">
                    <img
                      ...
                      alt="Feature Preview"
                      className="rounded-xl shadow-lg w-full max-w-md border border-blue-200/40 transition-all duration-500"
                    />
                  </div>
                </section>
              );
        ...
        {/* Section Divider */}
        <div className="w-full flex justify-center my-20 bg-gradient-to-br from-blue-50 via-purple-50 to-green-50">
          <div className="w-24 h-1 rounded-full bg-gradient-to-r from-blue-400 via-purple-400 to-green-400 opacity-60"></div>
        </div>

        {/* Final CTA Section */}
        <FadeInSection>
          <div className="w-full flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 via-purple-50 to-green-50 py-16">
            <div className="bg-white/80 backdrop-blur-md rounded-3xl px-12 py-14 border-2 border-blue-200/40 shadow-2xl max-w-2xl text-center">
              <h2 className="text-4xl font-extrabold text-gray-800 mb-6 tracking-tight">Ready to Get Started?</h2>
              <p className="text-2xl text-gray-700 mb-8 leading-relaxed">
                Elevate your content game with our free tier <span className="font-bold text-blue-600">25 tokens</span> with built-in AI calls, plus <span className="font-bold text-blue-600">75 tokens</span> with your own API keys.
              </p>
              <a
                href="/signup"
                className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-bold px-12 py-5 rounded-2xl text-2xl transition-all shadow-xl"
              >
                Get Started &rarr;
              </a>
            </div>
