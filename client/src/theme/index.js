  ...
  components: {
    ...
    card: {
      variants: {
        ...
        interactive: 'bg-white border border-neutral-200 shadow-sm hover:shadow-md transition-shadow duration-200',
      },
      padding: {
        sm: 'p-4',
        md: 'p-6',
...
export const getAnimation = (name) => theme.animation.presets[name] || name

export const getComponentVariant = (component, variant) => {
  return theme.components[component]?.variants[variant] || ''
}

export const getComponentSize = (component, size) => {
  return theme.components[component]?.sizes[size] || ''
}