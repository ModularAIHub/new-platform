...
const AgencyWorkspaceShell = ({
  ...
  return (
    <div className="space-y-4 sm:space-y-5">
      <div className="rounded-[28px] border border-slate-200 bg-[linear-gradient(180deg,_rgba(255,255,255,0.98)_0%,_rgba(248,250,252,0.98)_100%)] p-4 shadow-[0_24px_70px_rgba(15,23,42,0.06)] sm:rounded-[30px] sm:p-5">
      ...
      <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_minmax(360px,0.9fr)] xl:gap-5">
        ...
        <div className="rounded-[26px] border border-slate-200 bg-white p-3 shadow-[0_18px_50px_rgba(15,23,42,0.05)] sm:rounded-[28px]">
            ...
            {WORKSPACE_SECTION_DEFINITIONS.map((section) => {
              ...
              return (
                <button
                  ...
                  className={`min-w-[240px] shrink-0 snap-start rounded-[22px] border px-4 py-4 text-left transition sm:min-w-[220px] ${
                    isActive
                ...
                >
                  <div className="flex items-start gap-3">
                    <div className={`rounded-2xl p-2.5 ${isActive ? 'bg-white/10 text-white' : 'bg-white text-slate-700'}`}>
