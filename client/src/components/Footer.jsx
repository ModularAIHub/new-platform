          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="flex gap-3">
                <a href="https://x.com/Suitegenie" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)" className="w-9 h-9 bg-white/10 hover:bg-primary-500/20 rounded-lg flex items-center justify-center text-neutral-300 hover:text-primary-400 transition-all duration-200">
